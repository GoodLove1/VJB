# Don't Remove Credit Tg - @Tamillogger
# Subscribe YouTube Channel For Amazing Bot https://youtube.com/@Tech_VJ
# Ask Doubt on telegram @Tamillogger

# Clone Code Credit : YT - @Tech_VJ / TG - @Tamillogger / GitHub - @VJBots
...
async def clone_menu(client, message):
    ...
    try:
        ...
        await msg.edit_text(f"⚠️ <b>Bot Error:</b>\n\n<code>{e}</code>\n\n**Kindly forward this message to @Tamillogger to get assistance.**")
